...
<img width="1857" height="899" alt="Screenshot 2026-08-01 111117" src="https://github.com/user-attachments/assets/f69b5f34-ee26-437d-8af0-4e47cd94cc96" />


[pa_simulator.html](https://github.com/user-attachments/files/30612180/pa_simulator.html)

Also fixing the tab-track reset to avoid `innerHTML` entirely, for consistency:All 8 scenes, folder-tab progress bar, stamp effects for denial/approval, and every bubble built via `createElement`/`appendChild` — no `innerHTML` anywhere, even on restart.
